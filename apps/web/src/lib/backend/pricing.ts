...
const CURRENCY_RATES: Record<string, number> = {
  INR: 1, USD: 0.012, AED: 0.044, GBP: 0.0095, AUD: 0.018,
  SGD: 0.016, CAD: 0.016, EUR: 0.011, MYR: 0.056,
  QAR: 0.044, SAR: 0.045, KWD: 0.0037,
}

export function calcServerPrice(productId: string, durationMonths: number, currency: string) {
...
export function verifyPrice(
  productId: string, durationMonths: number, currency: string, submittedTotal: number, tolerancePercent = 2
): boolean {
