...
import { PRODUCTS, CATEGORIES } from '@primekeys/shared'
    ...
    <main style={{ background: '#000', minHeight: '100vh', paddingTop: 52 }}>
      ...
      <div className="pk-grain" style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            ...
            No setup. No hassle. Just access.
          </motion.p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '56px 28px 120px' }}>
              ...
              return (
                <motion.button
                  ...
                  style={{
                    ...
                    border: sel ? '1px solid rgba(212,175,55,0.55)' : '1px solid rgba(255,255,255,0.08)',
                    fontSize: 13, fontWeight: sel ? 600 : 400, cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    background: sel ? 'rgba(212,175,55,0.12)' : 'rgba(255,255,255,0.03)',
                    color: sel ? '#D4AF37' : '#6e6e73',
                    letterSpacing: '-0.01em',
                    boxShadow: sel ? '0 0 12px rgba(212,175,55,0.12)' : 'none',
                  }}
                >
                  <span style={{ color: sel ? '#D4AF37' : '#4a4a50' }}>
                    {catIcons[cat.id] ?? catIcons.all}
                  </span>
                  {cat.label}
                </motion.button>
              )
          ...
          >
            ...
            {products.length === 0 && (
              <div style={{ textAlign: 'center', padding: '80px 0', color: '#3a3a3e' }}>
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#3a3a3e" strokeWidth="1.5" style={{ marginBottom: 16 }}>
        ...
        <SectionReveal delay={0.1}>
          <div style={{
            marginTop: 80, padding: '36px 32px',
            ...
            <div>
              <p style={{ fontSize: 18, fontWeight: 700, color: '#f5f5f7', letterSpacing: '-0.02em', marginBottom: 4 }}>
                Need something custom?
              </p>
              <p style={{ fontSize: 14, color: '#6e6e73', lineHeight: 1.5 }}>
                Bulk orders, gift accounts, or a platform not listed — we&apos;ve got you.
              </p>
            </div>
            <a
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.47 14.38c-.28-.14-1.65-.81-1.91-.9-.26-.1-.44-.14-.63.14-.19.28-.72.9-.88 1.09-.16.18-.33.2-.61.07-.28-.14-1.19-.44-2.27-1.4-.84-.75-1.4-1.67-1.57-1.95-.16-.28-.02-.43.12-.57.13-.12.28-.33.43-.49.14-.16.19-.28.28-.46.1-.18.05-.35-.02-.49-.07-.14-.63-1.52-.86-2.08-.23-.55-.47-.47-.63-.48-.16 0-.35-.02-.54-.02-.19 0-.49.07-.74.35-.26.28-.98.96-.98 2.33 0 1.38 1 2.71 1.13 2.89.14.18 1.97 3 4.77 4.21.67.29 1.19.46 1.59.59.67.21 1.28.18 1.76.11.54-.08 1.65-.67 1.88-1.33.23-.65.23-1.21.16-1.33-.07-.12-.26-.19-.54-.33z"/>
                <path d="M12 0C5.37 0 0 5.37 0 12c0 2.12.55 4.1 1.52 5.82L0 24l6.35-1.66A11.94 11.94 0 0 0 12 24c6.63 0 12-5.37 12-12S18.63 0 12 0zm0 21.8a9.76 9.76 0 0 1-4.96-1.35l-.35-.21-3.68.96 1-3.57-.23-.37A9.78 9.78 0 0 1 2.2 12C2.2 6.58 6.58 2.2 12 2.2c5.42 0 9.8 4.38 9.8 9.8 0 5.42-4.38 9.8-9.8 9.8z"/>
              </svg>
              WhatsApp us
            </a>
          </div>
